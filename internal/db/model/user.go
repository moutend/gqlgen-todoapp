...
var (
	userAllColumns            = []string{"id", "name", "password_hash", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"name", "password_hash", "created_at", "updated_at", "deleted_at"}
...
func (o *User) Tasks(mods ...qm.QueryMod) taskQuery {
	...
	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`task`.*"})
	}
...
func (userL) LoadTasks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(qm.From(`task`), qm.WhereIn(`task.user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on task")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for user")
	}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for user")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for user")
	}
